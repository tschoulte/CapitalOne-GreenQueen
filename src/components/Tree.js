...
class Tree extends Component {
    constructor(props) {
      ...
      componentDidMount(){
        // setTimeout(() => {
        //   // Find actual progress and set here
      ...
      render() {
        return (
          <div class="container">
            <svg id="animation" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" viewBox="0 0 302.7 436.37">
              <defs>
                ...
                <linearGradient id="Dégradé_sans_nom_4-2" x1="196.6" y1="195.74" x2="177" y2="178.38" href="#Dégradé_sans_nom_4"/>
                <linearGradient id="Dégradé_sans_nom_3-2" x1="296.11" y1="44.64" x2="176.48" y2="155.68" href="#Dégradé_sans_nom_3"/>
                <linearGradient id="Dégradé_sans_nom_2-2" x1="274.3" y1="150.3" x2="231.97" y2="99.99" href="#Dégradé_sans_nom_2"/>
                <linearGradient id="Dégradé_sans_nom_4-3" x1="-19.56" y1="223.16" x2="218.1" y2="279.92" href="#Dégradé_sans_nom_4"/>
                <linearGradient id="Dégradé_sans_nom_2-3" x1="16.11" y1="204.08" x2="92.18" y2="276.48" href="#Dégradé_sans_nom_2"/>
                <linearGradient id="Dégradé_sans_nom_2-4" x1="106.7" y1="255.03" x2="106.7" y2="255.03" href="#Dégradé_sans_nom_2"/>
                <linearGradient id="Dégradé_sans_nom_3-3" x1="63.36" y1="209.36" x2="54.16" y2="240.65" href="#Dégradé_sans_nom_3"/>
                <linearGradient id="Dégradé_sans_nom_4-4" x1="75.32" y1="182.31" x2="144.32" y2="160.33" href="#Dégradé_sans_nom_4"/>
                <linearGradient id="Dégradé_sans_nom_2-5" x1="19.89" y1="76.27" x2="141.37" y2="193.45" href="#Dégradé_sans_nom_2"/>
                <linearGradient id="Dégradé_sans_nom_3-4" x1="38.58" y1="178.83" x2="83.36" y2="134.66" href="#Dégradé_sans_nom_3"/>
                ...
                <linearGradient id="Dégradé_sans_nom_2-6" x1="147.41" y1="4.1" x2="181.15" y2="164.83" href="#Dégradé_sans_nom_2"/>
                <linearGradient id="Dégradé_sans_nom_3-5" x1="98.37" y1="94.42" x2="168.31" y2="80.31" href="#Dégradé_sans_nom_3"/>
              </defs>
              <title>Your Progress Tree</title>
              <g id="shadow">
